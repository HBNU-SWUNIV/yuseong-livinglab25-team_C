...
function CustomNotificationSearchBar({
  searchQuery,
  onSearchChange,
  onSearch,
  onReset,
    ...
    <>
      <SearchBarContainer>
        ...
        <FilterRow>
          ...
          <MessageTypeWrapper>
            <MessageTypeDropdown
              value={messageType === '전체' ? 'ALL' : messageType}
              onChange={(value) => {
                const mappedValue = value === 'ALL' ? '전체' : value;
...
export default CustomNotificationSearchBar;
